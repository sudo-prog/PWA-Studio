  ...
  return (
    <NativeTabs>
      ...
      <NativeTabs.Trigger name="canvas">
        <Icon sf={{ default: "pencil.tip", selected: "pencil.tip.crop.circle.fill" }} />
        <Label>Canvas</Label>
      </NativeTabs.Trigger>
      <NativeTabs.Trigger name="kanban">
        <Icon sf={{ default: "square.grid.3x1.below.line.grid.1x2", selected: "square.grid.3x1.below.line.grid.1x2" }} />
        <Label>Board</Label>
      </NativeTabs.Trigger>
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color }) =>
            isIOS ? (
              <SymbolView name="pencil.tip" tintColor={color} size={22} />
            ) : (
